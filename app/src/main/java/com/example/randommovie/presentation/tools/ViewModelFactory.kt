...
import com.example.randommovie.presentation.screen.tabs.settings.auth.login.LoginViewModel
...
import com.example.randommovie.presentation.screen.tabs.settings.auth.registration.ConfirmViewModel
